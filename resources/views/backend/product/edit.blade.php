        ...
        <div class="col-sm-12">
            <form action="" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" name="old_charge" class="form-control"
                                   value="{{ $product->old_charge }}"
                                   placeholder="原价">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" name="now_charge" class="form-control"
                                   value="{{ $product->now_charge }}"
                                   placeholder="现价">
                            <div class="input-group-addon">元</div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" name="sales_num" class="form-control"
                                   value="{{ $product->sales_num }}"
                                   placeholder="销量">
                            <div class="input-group-addon">件</div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="description" class="form-control"
                                  cols="30" rows="5"
                                  placeholder="产品描述">{{ $product->detail->description }}</textarea>
                    </div>
                </div>
                <div class="form-group">
